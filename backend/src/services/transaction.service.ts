...
import { calculatedDateNextOccurrence } from "../utils/helper";
import {
...
export const createTransactionService = async (
  ...
  if (body.isRecurring && body.recurringInterval) {
    const calculatedDate = calculatedDateNextOccurrence(
      body.date,
    ...
    nextRecurringDate =
      calculatedDate < currentDate
        ? calculatedDateNextOccurrence(currentDate, body.recurringInterval)
        : calculatedDate;
  }
...
export const duplicateTransactionService = async (
  ...
  const duplicated = await TransactionModel.create({
    ...
    createdAt: undefined, // Reset createdAt to current time
    updatedAt: undefined, // Reset updatedAt to current time
  });
...
export const updateTransactionService = async (
  ...
  if (isRecurring && recurringInterval) {
    ...
    nextRecurringDate =
      calculatedDate < now
        ? calculatedDateNextOccurrence(now, recurringInterval)
        : calculatedDate;
  }
